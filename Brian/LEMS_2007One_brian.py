...
# Saving to file: RS_One.dat, reference: of0
all_of0 = np.array( [ record_of0__v.times, record_of0__v[0] , record_of0__u[0]  ] )
...
if show_gui:
    ...
    plot_RSv.plot(trace_d1__RSv.times/second,trace_d1__RSv[0], color="#0000ff", label="RSv")
    plot_RSv.legend()

    # Display: Component(id=d2 type=Display)
    display_d2 = plt.figure("RS u")
    plot_RS_u = display_d2.add_subplot(111, autoscale_on=True)
    plot_RS_u.plot(trace_d2__RS_u.times/second,trace_d2__RS_u[0], color="#ff0000", label="RS u")
    plot_RS_u.legend()
    plt.show()
